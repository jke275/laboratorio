<div class="container">
	<div class="bs-component col-lg-8 col-lg-offset-2">
		<ul class="nav nav-pills nav-justified" style="margin-bottom: 15px;">
			<li class="active"><a aria-expanded="true" href="#uno" data-toggle="tab">Agregar Un instrumento<div class="ripple-container"></div></a></li>
			<li class=""><a aria-expanded="false" href="#varios" data-toggle="tab">Agregar Varios instrumentos<div class="ripple-container"></div></a></li>
		</ul>
...
<script type="text/javascript">
	function upload(){
      ...
      formData.append("upload", file.files[0]);
		ajax.open("POST", "<?php echo URL . 'app/ajax/' ?>agregar_material.php", true);
