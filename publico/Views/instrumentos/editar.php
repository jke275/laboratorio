		...
		<div class="col-lg-8 col-lg-offset-2">
			...
			<form action="" method="POST" class="bs-component">
				<div class="form-group form-group-lg" id="nombre-input">
					...
					<input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo ($datos['nombre_inv']) ?  ucwords($datos['nombre_inv']) : $_POST['nombre']?>" />
				</div>
				<div class="form-group form-group-lg" id="caracteristicas-input">
					...
					<input type="text" id="caracteristicas" name="caracteristicas" class="form-control" value="<?php echo ($datos['carac_material']) ?  ucwords($datos['carac_material']) : $_POST['caracteristicas']?>">
				</div>
				<br>
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
						<button type="submit" class="btn btn-raised btn-primary">Actualizar</button>
						<a href="<?php echo URL, 'instrumentos/ver/', $codigo ?>"><button type="button" class="btn btn-raised btn-primary">Cancelar</button></a>
					</div>
				</div>
			</form>
		</div>
