	...
	<div class="col-lg-9">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<span class="big-font"><?php echo ucfirst($info['carac_material']) ?></span>
			</div>
		</div>
		<div class="divider"></div>
		<div class="row">
			<div class="btn-group btn-group-raised">
				<a href = "<?php echo URL, 'instrumentos/editar/', $info['codigo_inv']; ?>" class="btn">Editar</a>
				<a href = "<?php echo URL, 'instrumentos/drop/', $info['codigo_inv']; ?>" class="btn drop">Eliminar</a>
				<a href = "<?php echo URL, 'instrumentos'; ?>" class="btn">Regresar</a>
			</div>
		</div>
	</div>
	<div class="col-lg-3">
		...
		<table class="table table-hover">
			...
			<?php
				foreach($codigos as $codigo){
					echo '<tr>';
					echo '<td>', mb_strtoupper($codigo['codigo_etiqueta']), '</td>';
					echo '<td>', ucfirst($codigo['estado']), '</td>';
					echo '<td>';
					echo '<a data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar código" href = "', URL, 'instrumentos/editar_codigo/' . $info['codigo_inv'] . '/' . str_replace(' ', '_', $codigo['codigo_etiqueta']) . '"><i class="material-icons prefix">mode_edit</i></a>';
					echo '<a data-toggle="tooltip" data-placement="rigth" title="" data-original-title="Eliminar" href = "', URL, 'instrumentos/eliminar/' . $info['codigo_inv'] . '/' . $codigo['codigo_etiqueta'] . '" class="eliminar"><i class="material-icons prefix">delete</i></a>';
					echo '</td>';
					echo '</tr>';
				}
			?>
