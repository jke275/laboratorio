		...
		<div class="col-lg-8 col-lg-offset-2">
			...
			<form action="" method="POST" class="bs-component">
				...
				<div class="form-group form-group-lg" id="marca-input">
					...
					<input type="text" id="marca" name="marca" class="form-control" value="<?php echo ($datos['marca_equipo']) ?  $datos['marca_equipo'] : $_POST['marca']?>">
				</div>
				<div class="form-group form-group-lg" id="modelo-input">
					<label for="modelo"  class="control-label">Modelo</label>
					<input type="text" id="modelo" name="modelo" class="form-control" value="<?php echo ($datos['modelo_equipo']) ?  $datos['modelo_equipo'] : $_POST['modelo']?>">
				</div>
				<div class="form-group form-group-lg" id="serie-input">
					<label for="serie"  class="control-label">Número de Serie</label>
					<input type="text" id="serie" name="serie" class="form-control" value="<?php echo ($datos['numero_serie']) ?  $datos['numero_serie'] : $_POST['serie']?>">
				</div>
				<div class="form-group form-group-lg" id="caracteristicas-input">
					...
					<input type="text" id="caracteristicas" name="caracteristicas" class="form-control" value="<?php echo ($datos['carac_equipo']) ?  $datos['carac_equipo'] : $_POST['caracteristicas']?>">
				</div>
				<br>
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
						<button type="submit" class="btn btn-raised btn-primary">Actualizar</button>
						<a href="<?php echo URL, 'equipo/ver/', $codigo ?>"><button type="button" class="btn btn-raised btn-primary">Cancelar</button></a>
					</div>
				</div>
			</form>
		</div>
