<div class="container">
	<div class="bs-component col-lg-8 col-lg-offset-2">
		<ul class="nav nav-pills nav-justified" style="margin-bottom: 15px;">
			<li class="active"><a aria-expanded="true" href="#uno" data-toggle="tab">Agregar Un Elemento<div class="ripple-container"></div></a></li>
			<li class=""><a aria-expanded="false" href="#varios" data-toggle="tab">Agregar Varios Elementos<div class="ripple-container"></div></a></li>
		</ul>
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane fade active in" id="uno">
				<div class="col-lg-12">
					<h2 class="text-center">Agregar nuevo Mobiliario</h2>
...
<script type="text/javascript">
	function upload(){
      ...
      /* Add the file */
		...
		ajax.open("POST", "<?php echo URL . 'app/ajax/' ?>agregar_mobiliario.php", true);
