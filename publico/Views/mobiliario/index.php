<?php
	...
	function comprimido($datos){
		...
		foreach($datos as $fila){
			...
			$table .= '<td>' . ucfirst($fila['carac_mobiliario']) . '</td>';
			$table .= '<td><a href = "' . URL. 'mobiliario/ver/' . $fila['codigo_inv'] . '"><i class="material-icons prefix">forward</i></a></td>';
			$table .= '</tr>';
		}
		$table .= '</tbody>';
		$table .= '</table>';
	...
	<div class="row">
		...
		<div class="col-lg-2 col-lg-offset-6">
			<form action="<?php echo URL ?>pdf.php" method="POST" id="pdf">
				...
				<input type="hidden" name="name" id="name" value="inventario_mobiliario">
...
<script type="text/javascript">
	...
	function pdf(){
		...
		table = '<div class="row" style="background-color: #888888;"><div class="col-xs-10"><strong><h3 class="header">Inventario del Mobiliario del Laboratorio de <?php echo ucwords(Config::get("laboratorio")) ?></h3></strong></div></div><br>' + table.join('<tr>');
